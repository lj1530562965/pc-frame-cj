...
<div>
  ...
  <Row>
    <Col span="8" offset="1">
    	<div id="echartContainer1" style="height:300px"></div>
    </Col>
    <Col span="10" offset="1">
    	<div id="echartContainer2" style="height:300px"></div>
    </Col>
  </Row>
    <Row>
    <Col span="8" offset="1">
    	<div id="echartContainer5" style="height:300px"></div>
    </Col>
    <Col span="10" offset="1">
    	<div id="echartContainer6" style="height:300px"></div>
    </Col>
  </Row>
    <Row>
     <Col span="22" offset="1">
    	<div id="echartContainer3" style="height:500px"></div>
    </Col>
  </Row>
  <Row>
    <!--创建一个echarts的容器-->
    <Col span="22">
    	<div id="echartContainer4" style="height:500px"></div>
    </Col>
  </Row>
</div>
</template>
<script>
  ...
  export default {
    ...
    methods: {
    		chart3:function () {
    			var dom = document.getElementById("echartContainer3");
    		...
    		chart4:function () {
    			var app = {};
    			var myChart = echarts.init(document.getElementById('echartContainer4'));
				var option = null;
				option = {
				    title: {
				        text: '未来一周气温变化',
    		...
    		chart5:function() {
    			var dom = document.getElementById("echartContainer5");
				var myChart = echarts.init(dom);
				var app = {};
				var option = null;
				option = {
    		...
    		chart6:function() {
var dom = document.getElementById("echartContainer6");
var myChart = echarts.init(dom);
var app = {};
var option = null;
option = {
...
if (option && typeof option === "object") {
    ...
    // 		chart4:function () {
    // 			var dom = document.getElementById("echartContainer4");
				// var myChart = echarts.init(dom);
				// var app = {};
				// var option = null;
				// var data = [
