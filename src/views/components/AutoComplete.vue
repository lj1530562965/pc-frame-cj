<template>
  <div>
      <Row>
          <Col span="11">
          <Card class="card">
              <p slot="title">基本用法，通过 data 设置自动完成的数据源</p>
              <AutoComplete
                      v-model="value1"
                      :data="data1"
          ...
          <Card class="card">
              <p slot="title">除了使用 data，还可以直接传入 Option 组件作为 slot 使用，这样可以自定义显示效果</p>
              <AutoComplete
                      v-model="value2"
      ...
      <Row>
          <Col span="11">
          <Card class="card">
              <p slot="title">不区分大小写的 AutoComplete，及过滤的用法</p>
              <AutoComplete
                      v-model="value3"
                      :data="data3"
          ...
          <Col span="11" offset="2">
          <Card class="card">
              <p slot="title">完全自定义 Option，显示复杂的布局。</p>
              <AutoComplete
                      v-model="value4"
                      icon="ios-search"
                      placeholder="input here"
